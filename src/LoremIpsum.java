...
public class LoremIpsum {
    ...
    public static void main(String[] args) {
        WordsChecker wordsChecker = new WordsChecker(LOREM_IPSUM);
        boolean ipsum = wordsChecker.hasWord("ipsum");
        System.out.println(ipsum);

        char[] arr = LOREM_IPSUM.toLowerCase(Locale.ROOT).toCharArray();
        ...
        System.out.println("Максимальное количество вхождений: ");
        ...
        System.out.println("Минимальное количество вхождений: ");
        for(Map.Entry<Character, Integer> entry : symbols.entrySet()){
